...
class TextAnimationLayer: CALayer, NSLayoutManagerDelegate {
    ...
    public var typeAnimation: TextAnimationType = .none
    ...
    func addAnimations(to layers: [CATextLayer], type: TextAnimationType) {
    ...
    private func updateAnimationLayers() {
        ...
        addAnimations(to: animationLayers, type: typeAnimation)
    }
